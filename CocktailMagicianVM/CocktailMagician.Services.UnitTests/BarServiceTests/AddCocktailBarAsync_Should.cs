...
{
    [TestClass]
   public class AddCocktailBarAsync_Should
    {
        [TestMethod]

        public async Task Should_CreateCocktailBarCorrectly()
        {
            //arrange
            ...
            var options = TestUtilities.GetOptions(nameof(Should_CreateCocktailBarCorrectly));
            ...
            using (var assertContext = new CocktailDatabaseContext(options))
            {
                ...
                await sut.AddCocktailBarAsync(barId,cocktailId);
                Assert.AreEqual(1, assertContext.BarCocktail.Count());
            }
        }
    }
}
